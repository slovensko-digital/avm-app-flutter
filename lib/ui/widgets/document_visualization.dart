...
Widget previewDocumentVisualization(BuildContext context) {
  const visualizations = <String, DocumentVisualizationResponseBody>{
    "PDF": DocumentVisualizationResponseBody(
    ...
    "text": DocumentVisualizationResponseBody(
      mimeType: "text/plain;base64",
      filename: "document.txt",
      content:
          "",
    ),
    "image": DocumentVisualizationResponseBody(
      mimeType: "text/html;base64",
      filename: "IMG-20240223-WA0001.jpg",
      content:
  ...
  final selectedVisualization =
      visualizations[selectedVisualizationKey] ?? visualizations.values.first;
