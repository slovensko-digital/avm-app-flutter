...
import 'package:eidmsdk/eidmsdk.dart' as _i15;
...
import 'bloc/paired_device_list_cubit.dart' as _i9;
import 'bloc/present_signed_document_cubit.dart' as _i10;
import 'bloc/preview_document_cubit.dart' as _i11;
import 'bloc/select_signing_certificate_cubit.dart' as _i12;
import 'bloc/sign_document_cubit.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.PairedDeviceListCubit>(
        () => _i9.PairedDeviceListCubit(service: gh<_i8.IAutogramService>()));
    gh.factoryParam<_i10.PresentSignedDocumentCubit,
        _i8.SignDocumentResponseBody, dynamic>((
      signedDocument,
      _,
    ) =>
        _i10.PresentSignedDocumentCubit(
    ...
    gh.factoryParam<_i12.SelectSigningCertificateCubit,
      ...
      _,
        ...
        _i12.SelectSigningCertificateCubit(
          eidmsdk: gh<_i15.Eidmsdk>(),
          signingCertificate: signingCertificate,
        ));
    gh.factoryParam<_i16.SignDocumentCubit, String, _i14.Certificate>((
      documentId,
      certificate,
    ) =>
        _i16.SignDocumentCubit(
          service: gh<_i8.IAutogramService>(),
          eidmsdk: gh<_i15.Eidmsdk>(),
          documentId: documentId,
